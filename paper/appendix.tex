...
\begin{minipage}[h]{\textwidth}
  ...
  \centering
  \input{../results/tables/aha-cohort-robust.tex}
\end{minipage}
\end{table}
...
\begin{minipage}[h]{\textwidth}
  ...
  \centering
  \input{../results/tables/career-stage.tex}
\end{minipage}
\end{table}
...
\begin{minipage}[h]{0.6\textwidth}
  ...
  \centering
  \input{../results/tables/movers-vs-full.tex}
\end{minipage}
\end{table}
...
\begin{minipage}[h]{\textwidth}
  ...
  \centering
  \resizebox{\textwidth}{!}{\input{../results/tables/robust-fe.tex}}
\end{minipage}
\end{table}
...
\begin{minipage}[h]{\textwidth}
  ...
  \centering
  \input{../results/tables/robust-quartiles.tex}
\end{minipage}
\end{table}
...
\begin{minipage}[h]{0.7\textwidth}
  ...
  \centering
  \input{../results/tables/fgw-decomp-top.tex}
\end{minipage}
\end{table}
...
\end{equation*}
with the direct training effect compounding through the destination feedback loop. The path approaches the long-run multiplier $1/(1 - \beta_{\text{dest}}) = 1.54$ asymptotically under our within-physician estimate of $\beta_{\text{dest}} = 0.35$. Half of the long-run effect is realized within roughly 10 years of the equalization shock, and the system reaches 95\% of steady state by year 20.
