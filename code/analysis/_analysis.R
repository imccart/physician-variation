...
source("code/analysis/6_rank.R")
source("code/analysis/7_aha_training.R")
source("code/analysis/8_rank_x_cath.R")
source("code/analysis/9_dynamic.R")
source("code/analysis/10_event_study.R")
source("code/analysis/11_heterogeneity.R")
source("code/analysis/12_mover_balance.R")
source("code/analysis/13_training_pipeline.R")
source("code/analysis/14_recent_grad_residency.R")
source("code/analysis/15_permutation.R")
